...
var Particles = /** @class */ function() {
     ...
     */ function Particles(container, svg, settings) {
        // Check args
        if (!(container instanceof HTMLElement)) throw new Error("PARTICLES\ncontainer arg must be an instance of HTMLElement");
        ...
        if (typeof settings.minDuration !== "number") throw new Error("PARTICLES\nsettings.minDuration must be a number");
        if (typeof settings.maxDuration !== "number") throw new Error("PARTICLES\nsettings.maxDuration must be a number");
        if (typeof settings.maxParticles !== "number") throw new Error("PARTICLES\nsettings.maxParticles must be a number");
